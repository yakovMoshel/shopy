  ...
  const testimonials = [
    {
      id: 1,
      name: 'רותי לוי',
      review: 'היה מדהים! המוצר שינה את חיי ואני ממליצה עליו בחום.',
    },
    {
      id: 2,
      name: 'אילנה כהן',
      review: 'שירות לקוחות מעולה ומוצרים איכותיים מאוד. בהחלט אחזור לקנות.',
    },
    {
      id: 3,
      name: 'מיכל ברק',
      review: 'קנייה מוצלחת, המוצר הגיע בזמן והאיכות הייתה מצוינת. ממליצה בחום!',
    },
  ];
